...
3. For each character to be encoded you make the call:
...
//   int Preset(int BandWidth=1000, int LongInterleave=0, char *ID=0);
   int SendTune(void);
...
4. After EACH new batch of samples
   ...
   You can examin the receiver status at any time by calling:
