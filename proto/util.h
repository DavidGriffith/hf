...
extern __inline__ void soft_to_hard(const int *inp, unsigned char *out, int nsamp, int spacing, int inv)
{
...
extern long soft_time_dev(l1_soft_t *inp, int nbits, int spacing, l1_time_t tinc);

/* --------------------------------------------------------------------- */

extern __inline__ int freq_tracking(l1_soft_t *inmid, l1_soft_t *inlo, l1_soft_t *inhi, int nbits,
				    int spacing, l1_soft_t *valmid, l1_soft_t *vallo, l1_soft_t *valhi)
{
...
extern __inline__ unsigned int gtor_calc_crc_ccitt(unsigned char *data, int len, 
						   unsigned int preset)
{
        unsigned int crc = preset;
